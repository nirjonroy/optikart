...
use App\Http\Controllers\WEB\Frontend\SolutionController as FrontSolutionController;
...
Route::group(['middleware' => ['demo', 'XSS']], function () {
    ...
    Route::group(['prefix' => 'admin', 'middleware' => 'auth', 'as' => 'admin.'], function () {
        ...
        Route::get('appointment-page', [AppointmentPageController::class, 'index'])->name('appointment-page.index');
        Route::post('appointment-page', [AppointmentPageController::class, 'store'])->name('appointment-page.store');
...
Route::group(['as' => 'front.'], function () {
    ...
    Route::get('/solutions', [FrontSolutionController::class, 'index'])->name('solutions');
