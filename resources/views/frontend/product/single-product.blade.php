<div>
    <div class="product">
      ...
      <a data-id="{{ $product->id }}" data-url="{{ route('front.cart.store') }}" class="buyText ag add-to-cart">
        <section class="addButtonWrapper border-radius-small">
          ...
          <div data-url="{{ route('front.cart.decrease', $product->slug) }}" style="display: inline;color: white;font-size: 16px;font-weight: 900;
    margin-right: 10px;;" class="caret caret-up increase" title="Add one more to bag">
         ...
         @endforeach
          ...
          <div data-url="{{ route('front.cart.increase', $product->slug) }}" style="display: inline;color: white;font-size: 16px;font-weight: 900;
