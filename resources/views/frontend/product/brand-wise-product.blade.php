...
<div class="container-fluid main-section" style="padding-bottom: 30px;
    padding-top: 11px;">
                ...
                <div class="product_thumb bg-white prd_img" style="">
                    <a class="primary_img " href="{{ route('front.product.show', $product->slug ) }}"><img src="{{ asset('uploads/custom-images2/'.$product->thumb_image) }}" class="primcusImg" alt="" style="width: 100%;"></a>
                    <a style="display: none;" class="secondary_img" href="{{ route('front.product.show', $product->slug ) }}"><img src="{{ asset('uploads/custom-images2/'.$product->thumb_image) }}" class="seccusImg" alt="" style=""></a>
                    
                    @if($product->offer_price > 0)
                    <div class="label_product" style="width: auto;padding: 0px 12px;">
                        <span class="label_sale" style="padding-top: 2px;">{{ __('Offer') }}</span>
                    </div>
                    @endif
                    ...
                    <div class="label_product" style="width: 46%; background:#0089ff; left: 0%; border-radius: 5px 30px 30px 5px">
                        <span class="label_sale" style="padding-top: 2px;">{{ __('Free Shipping') }}</span>
                    </div>
                    @endif
                </div>
    ...
    background-color: #fff;">
                    <h4 class="ps-1" style="height: 35px;text-align: center;">
                        <a href="{{ route('front.product.show', $product->slug ) }}" class="font-14" style="font-size:14px;color: #000;
                    ...
                    <div class="rounded-0 bg-muted p-2 d-flex justify-content-between">
                        ...
                        @if($product->type == 'variable' || $product->prod_color == 'varcolor') 
                      		<a href="{{ route('front.product.show', $product->slug ) }}"
                                         ...
                                         >
                                   <i class="fas fa-shopping-cart"></i> &ensp;  {{ __('Order Now') }}
                                      </a>
                      	@else
