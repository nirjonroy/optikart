        ...
        <!-- Products -->
            <section class="products-box col-lg-9 col-md-12">
                ...
                <div class="product_thumb bg-white prd_img" style="">
                    <a class="primary_img " href="{{ route('front.product.show', $product->slug ) }}"><img src="{{ asset('uploads/custom-images2/'.$product->thumb_image) }}" class="primcusImg" alt="" style=""></a>
                    <a class="secondary_img " href="{{ route('front.product.show', $product->slug ) }}"><img src="{{ asset('uploads/custom-images2/'.$product->thumb_image) }}" class="seccusImg" alt="" style=""></a>
