...
@section('admin-content')
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <a href="{{ route('admin.team-member.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{ __('admin.Add New') }}</a>
                <div class="row mt-4">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <table class="table table-striped" id="dataTable">
                                        ...
                                        <tbody>
                                            @foreach ($teamMembers as $member)
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset($member->photo) }}" width="120" alt="">
                                                    </td>
                                                    <td>{{ $member->name }}</td>
                                                    <td>{{ $member->role }}</td>
                                                    <td>
                                                        @if ($member->status == 1)
                                                            <a href="javascript:;" onclick="changeTeamMemberStatus({{ $member->id }})">
    ...
    <script>
        ...
        function changeTeamMemberStatus(id) {
            ...
            $.ajax({
                ...
                url: "{{ url('/admin/team-member-status/') }}" + "/" + id,
