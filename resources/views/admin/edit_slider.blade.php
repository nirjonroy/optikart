                        ...
                        <form action="{{ route('admin.slider.update',$slider->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" name="title" class="form-control" value="{{ old('title', $slider->title ?? $slider->title_one) }}">
                                </div>

                                <div class="form-group col-12">
                                    <label>{{ __('Subheading') }}</label>
                                    <textarea name="description" class="form-control" rows="3">{{ old('description', $slider->description ?? $slider->title_two) }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" name="btn_link" class="form-control" value="{{ old('btn_link', $slider->btn_link) }}" placeholder="/shop or https://example.com">
                                </div>
