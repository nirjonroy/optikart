            ...
            @if (auth()->user()->can('homepage-setting') ||
                ...
                <li class="{{ Route::is('admin.general-setting') ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ Route::is('admin.banking-partner.*') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.banking-partner.index') }}">{{ __('Banking Partners') }}</a></li>
                        <li class="{{ Route::is('admin.investor.*') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.investor.index') }}">{{ __('Investors') }}</a></li>
                        <li class="{{ Route::is('admin.team-member.*') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.team-member.index') }}">{{ __('Team Members') }}</a></li>
...
@endif-->
            ...
            <li
                class="nav-item dropdown {{ Route::is('admin.appointments.*') || Route::is('admin.appointment-page.*') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown">
                    <div class="icon">
                        <i class="fas fa-calendar-check"></i>
                    </div>
                    <span style="color:black">{{ __('admin.Appointments') }}</span>
                </a>
                <ul class="dropdown-menu">
                    <li class="{{ Route::is('admin.appointments.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.appointments.index') }}">
                            {{ __('admin.Appointment Requests') }}
                        </a>
                    </li>
                    <li class="{{ Route::is('admin.appointment-page.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('admin.appointment-page.index') }}">
                            {{ __('admin.Appointment Page') }}
                        </a>
                    </li>
                </ul>
            </li>
